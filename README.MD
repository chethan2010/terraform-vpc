Project: This Moduel is Developed for Expense Project

* Create VPC
* Attach Internet Gatway
* Create Public Subnet in two available Zones
* Create Private Subnets in two available zones
* Create DB Subnets in two available zones
* Created EIP
* Created NatGateway
* Created Route Tables
* Created Routes
* created route tabale associations
...
This module is developed for Expense Project. We are creating following resources. This module creates resources in first 2 AZ for HA.
